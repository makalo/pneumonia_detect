...
class SolverWrapper(object):
    ...
    def train_model(self, sess, max_iters):
        ...
        summary_w=tf.summary.FileWriter('/home/makalo/workspace/code/kaggle/Faster-RCNN_TF/log/',sess.graph)
        ...
        for iter in range(max_iters):
            ...
            summary_op_=sess.run(summary_op,feed_dict=feed_dict,options=run_options,run_metadata=run_metadata)
            summary_w.add_summary(summary_op_,iter)
